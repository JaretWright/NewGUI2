 ...
 * @author JWright
 */
public class ChangePWViewController implements Initializable, ControllerClass {
    ...
    public void changePWButtonPushed(ActionEvent event) throws IOException, NoSuchAlgorithmException, SQLException
    {
        ...
        else    
        {
            try
            {
               ...
               // sceneChanger.changeScene(event, "PersonView.fxml", "Edit Person", person, PersonViewController.class);  
            }
            catch (Exception e)
            {
